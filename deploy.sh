...
kubectl set image deployments/client-deployment client=halczy/multi-client:$SHA
kubectl set image deployments/worker-deployment worker=halczy/multi-worker:$SHA